...
///
PMNS_NSIs_IO::PMNS_NSIs_IO() : PMNS_Fast(), fEta()
{
  SetStdPath();
...
void PMNS_NSIs_IO::SetNSIs(double eta_ee,      double eta_emu,      double eta_etau,
...
///
void PMNS_NSIs_IO::SetEta(int flvi, int flvj, double val, double phase){
...
///
complexD PMNS_NSIs_IO::GetEta(int flvi, int flvj){
...
void PMNS_NSIs_IO::SetLowestMass(double m3){
...
///
void PMNS_NSIs_IO::SetEta_ee(double a){ SetEta(0,0, a, 0); }
...
///
void PMNS_NSIs_IO::SetEta_mumu(double a){ SetEta(1,1, a, 0); }
...
///
void PMNS_NSIs_IO::SetEta_tautau(double a){ SetEta(2,2, a, 0); }

//......................................................................

void PMNS_NSIs_IO::SetEta_emu(double a, double phi){ SetEta(0,1, a, phi); }
...
/// @param a - The value of the real parameter eta_mumu
///
void PMNS_NSIs_IO::SetEta_mutau(double a, double phi){ SetEta(1,2, a, phi); }
...
/// @param a - The value of the real parameter eta_tautau
///
void PMNS_NSIs_IO::SetEta_etau(double a, double phi){ SetEta(0,2, a, phi); }


////Set lightest neutrino mass
void PMNS_NSIs_IO::SetM3(double m3){ SetLowestMass(m3);}

double PMNS_NSIs_IO::GetM3(){ return fM3;}
