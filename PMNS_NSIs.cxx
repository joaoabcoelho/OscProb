...
///
PMNS_NSIs::PMNS_NSIs() : PMNS_Fast(), fEta()
{
  SetStdPath();
...
void PMNS_NSIs::SetNSIs(double eta_ee,      double eta_emu,      double eta_etau,
...
///
void PMNS_NSIs::SetEta(int flvi, int flvj, double val, double phase){
...
///
complexD PMNS_NSIs::GetEta(int flvi, int flvj){
...
void PMNS_NSIs::SetLowestMass(double m){
...
///
void PMNS_NSIs::SetEta_ee(double a){ SetEta(0,0, a, 0); }
...
///
void PMNS_NSIs::SetEta_mumu(double a){ SetEta(1,1, a, 0); }
...
///
void PMNS_NSIs::SetEta_tautau(double a){ SetEta(2,2, a, 0); }

//......................................................................

void PMNS_NSIs::SetEta_emu(double a, double phi){ SetEta(0,1, a, phi); }
...
/// @param a - The value of the real parameter eta_mumu
///
void PMNS_NSIs::SetEta_mutau(double a, double phi){ SetEta(1,2, a, phi); }
...
/// @param a - The value of the real parameter eta_tautau
///
void PMNS_NSIs::SetEta_etau(double a, double phi){ SetEta(0,2, a, phi); }


////Set lightest neutrino mass
void PMNS_NSIs::SetM(double m){ SetLowestMass(m);}

double PMNS_NSIs::GetM(){ return fM;}
