...
/// @param delta_aT_etau  - The phase of the complex parameter aT_etau in
/// radians
/// @param delta_aT_mutau - The phase of the complex parameter aT_mutau in
/// radians
...
/// @param delta_cT_etau  - The phase of the complex parameter cT_etau in
/// radians
/// @param delta_cT_mutau - The phase of the complex parameter cT_mutau in
/// radians
///
void PMNS_LIV::SetLIV(double aT_ee, double aT_mumu, double aT_tautau,
                      ...
                      double delta_aT_emu, double delta_aT_etau,
                      double delta_aT_mutau, double delta_cT_emu,
                      double delta_cT_etau, double delta_cT_mutau)
{
  SetaT(0, 0, aT_ee, 0);
  SetaT(1, 1, aT_mumu, 0);
