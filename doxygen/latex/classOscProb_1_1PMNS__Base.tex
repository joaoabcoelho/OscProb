...
Definition at line 1325 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1326 \{
1327 
1328   \textcolor{comment}{// Do nothing if energy is not positive}
1329   \textcolor{keywordflow}{if}(E<=0) \textcolor{keywordflow}{return} 0;
1330 
1331   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a69db9d57e12fc7cbe0431bc6c18fac93}{fNuPaths}.empty()) \textcolor{keywordflow}{return} 0;
1332 
1333   \textcolor{comment}{// Don't average zero width}
1334   \textcolor{keywordflow}{if}(dE<=0) \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(nu\_in, flvf, E);
1335 
1336   \textcolor{comment}{// Make sure fPath is set}
1337   \textcolor{comment}{// Use average if multiple paths}
1338   \hyperlink{classOscProb_1_1PMNS__Base_a986e6ebef09a7e2eb7fee16a4c2c834d}{SetCurPath}(\hyperlink{namespaceOscProb_a999a7944bad8bc72d7ee9f56f81a210e}{AvgPath}(\hyperlink{classOscProb_1_1PMNS__Base_a69db9d57e12fc7cbe0431bc6c18fac93}{fNuPaths}));
1339 
1340   \textcolor{comment}{// Define L/E variables}
1341   \textcolor{keywordtype}{double} LoE = 0;
1342   \textcolor{keywordtype}{double} dLoE = 0;
1343 
1344   \textcolor{comment}{// Set a minimum energy}
1345   \textcolor{keywordtype}{double} minE = 0.1 * E;
1346 
1347   \textcolor{comment}{// Transform range to L/E}
1348   \textcolor{comment}{// Full range if low edge > minE}
1349   \textcolor{keywordflow}{if}(E-dE/2 > minE)\{
1350     LoE = 0.5 * (\hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E-dE/2) + \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E+dE/2));
1351     dLoE = \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E-dE/2) - \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E+dE/2);
1352   \}
1353   \textcolor{comment}{// Else start at minE}
1354   \textcolor{keywordflow}{else}\{
1355     LoE = 0.5 * (\hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/minE + \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E+dE/2));
1356     dLoE = \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/minE - \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/(E+dE/2);
1357   \}
1358 
1359   \textcolor{comment}{// Compute average in LoE}
1360   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_a19f160c045a01e5083506e925fb37d44}{AvgProbLoE}(nu\_in, flvf, LoE, dLoE);
1361 
1362 \}
\end{DoxyCode}
...
Definition at line 1292 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1296 
1297   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_a89e54c80ae8a31effbab7b2b970606bb}{AvgProb}(\hyperlink{classOscProb_1_1PMNS__Base_abf99f2339e3ee989600740b5d88063e8}{fNuState}, flvf, E, dE);
1298 
1299 \}
\end{DoxyCode}
...
Definition at line 1425 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1426 \{
1427 
1428   \textcolor{comment}{// Do nothing if L/E is not positive}
1429   \textcolor{keywordflow}{if}(LoE<=0) \textcolor{keywordflow}{return} 0;
1430 
1431   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a69db9d57e12fc7cbe0431bc6c18fac93}{fNuPaths}.empty()) \textcolor{keywordflow}{return} 0;
1432 
1433   \textcolor{comment}{// Make sure fPath is set}
1434   \textcolor{comment}{// Use average if multiple paths}
1435   \hyperlink{classOscProb_1_1PMNS__Base_a986e6ebef09a7e2eb7fee16a4c2c834d}{SetCurPath}(\hyperlink{namespaceOscProb_a999a7944bad8bc72d7ee9f56f81a210e}{AvgPath}(\hyperlink{classOscProb_1_1PMNS__Base_a69db9d57e12fc7cbe0431bc6c18fac93}{fNuPaths}));
1436 
1437   \textcolor{comment}{// Set the energy at bin center}
1438   \hyperlink{classOscProb_1_1PMNS__Base_a95b3b0d0cab5e6a54b5ef99587f837c0}{SetEnergy}(\hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length}/LoE);
1439 
1440   \textcolor{comment}{// Don't average zero width}
1441   \textcolor{keywordflow}{if}(dLoE<=0) \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(nu\_in, flvf);
1442 
1443   \textcolor{comment}{// Get sample points for this bin}
1444   vector<double> samples = \hyperlink{classOscProb_1_1PMNS__Base_a9eac8d768c1424755ee41f7e783af179}{GetSamplePoints}(LoE, dLoE);
1445 
1446   \textcolor{comment}{// Variables to fill sample}
1447   \textcolor{comment}{// probabilities and weights}
1448   \textcolor{keywordtype}{double} sumw = 0;
1449   \textcolor{keywordtype}{double} prob = 0;
1450   \textcolor{keywordtype}{double} length = \hyperlink{classOscProb_1_1PMNS__Base_a849437aa8891fe042e86886ce8f81c6e}{fPath}.\hyperlink{structOscProb_1_1NuPath_af22660894b6e25cf835500381b155557}{length};
1451 
1452   \textcolor{comment}{// Loop over all sample points}
1453   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<int(samples.size()); j++)\{
1454 
1455     \textcolor{comment}{// Set (L/E)^-2 weights}
1456     \textcolor{keywordtype}{double} w = 1./pow(samples[j],2);
1457 
1458     \textcolor{comment}{// Add weighted probability}
1459     prob += w * \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(nu\_in, flvf, length / samples[j]);
1460 
1461     \textcolor{comment}{// Increment sum of weights}
1462     sumw += w;
1463 
1464   \}
1465 
1466   \textcolor{comment}{// Return weighted average of probabilities}
1467   \textcolor{keywordflow}{return} prob / sumw;
1468 
1469 \}
\end{DoxyCode}
...
Definition at line 1390 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1394 
1395   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_a19f160c045a01e5083506e925fb37d44}{AvgProbLoE}(\hyperlink{classOscProb_1_1PMNS__Base_abf99f2339e3ee989600740b5d88063e8}{fNuState}, flvf, LoE, dLoE);
1396 
1397 \}
\end{DoxyCode}
...
Definition at line 1142 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1143 \{
1144 
1145   assert(nu\_in.size() == \hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus});
1146   assert(flvf >= 0 && flvf < \hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus});
1147 
1148   \hyperlink{classOscProb_1_1PMNS__Base_abf99f2339e3ee989600740b5d88063e8}{fNuState} = nu\_in;
1149 
1150   \hyperlink{classOscProb_1_1PMNS__Base_a054e3a8b05b9a958b6fa416e4a835e3e}{Propagate}();
1151 
1152   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_a0dc4d45bc3d7e03b9abbf5b4e100cc22}{P}(flvf);
1153 
1154 \}
\end{DoxyCode}
...
Definition at line 1171 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1172 \{
1173 
1174   \hyperlink{classOscProb_1_1PMNS__Base_a95b3b0d0cab5e6a54b5ef99587f837c0}{SetEnergy}(E);
1175 
1176   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(nu\_in, flvf);
1177 
1178 \}
\end{DoxyCode}
...
Definition at line 1226 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1227 \{
1228 
1229   \hyperlink{classOscProb_1_1PMNS__Base_a95b3b0d0cab5e6a54b5ef99587f837c0}{SetEnergy}(E);
1230   \hyperlink{classOscProb_1_1PMNS__Base_a6241325b1bd28cafa556daaecbe4ed62}{SetLength}(L);
1231 
1232   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(nu\_in, flvf);
1233 
1234 \}
\end{DoxyCode}
...
1123 
1124   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(\hyperlink{classOscProb_1_1PMNS__Base_abf99f2339e3ee989600740b5d88063e8}{fNuState}, flvf);
1125 
1126 \}
\end{DoxyCode}
...
Definition at line 1195 of file P\+M\+N\+S\+\_\+\+Base.\+cxx.
...
1199 
1200   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(flvi, flvf);
1201 
1202 \}
\end{DoxyCode}
...
1263 
1264   \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Base_aa2e10704d2d205a1ec8988de14b1a66f}{Prob}(flvi, flvf);
1265 
1266 \}
\end{DoxyCode}
...
Referenced by Avg\+Prob(), Avg\+Prob\+Lo\+E(), P\+M\+N\+S\+\_\+\+Base(), and Prob().
...
Definition at line 206 of file P\+M\+N\+S\+\_\+\+Base.\+h.
...
Referenced by Avg\+Prob(), Avg\+Prob\+Lo\+E(), Initialize\+Vectors(), P(), Prob(), Propagate\+Path(), and Reset\+To\+Flavour().
...
Definition at line 135 of file P\+M\+N\+S\+\_\+\+Base.\+h.
...
Definition at line 131 of file P\+M\+N\+S\+\_\+\+Base.\+h.
