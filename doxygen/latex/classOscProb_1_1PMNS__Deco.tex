...
Definition at line 183 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
184 \{
185 
186   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} out(3, \hyperlink{classOscProb_1_1PMNS__Deco_a34634741bc68bc1c524cf47f44e7f5b6}{row}(3,0));
187   
188   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<3; i++)\{
189   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<3; j++)\{
190   
191     out[i][j] += conj(A[j][i]);
192 
193   \}\}
194   
195   \textcolor{keywordflow}{return} out;
196 
197 \}
\end{DoxyCode}
...
Definition at line 135 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
136 \{
137 
138   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} out(3, \hyperlink{classOscProb_1_1PMNS__Deco_a34634741bc68bc1c524cf47f44e7f5b6}{row}(3,0));
139   
140   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<3; i++)\{
141   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<3; j++)\{
142   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} k=0; k<3; k++)\{
143 
144     out[i][j] += A[i][k] * B[k][j];
145 
146   \}\}\}
147   
148   \textcolor{keywordflow}{return} out;
149 
150 \}
\end{DoxyCode}
...
Definition at line 98 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
99 \{
100 
101   \textcolor{keywordflow}{if}(i < j)\{
102     cout << \textcolor{stringliteral}{"First argument should be larger than second argument"} << endl;
103     cout << \textcolor{stringliteral}{"Setting reverse order (Gamma\_"} << j << i << \textcolor{stringliteral}{"). "} << endl;
104     \textcolor{keywordtype}{int} temp = i;
105     i = j;
106     j = temp;
107   \}
108   \textcolor{keywordflow}{if}(i<1 || i>3 || i <= j || j < 1)\{
109     cout << \textcolor{stringliteral}{"Gamma\_"} << i << j << \textcolor{stringliteral}{" not valid for "} << \hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus};
110     cout << \textcolor{stringliteral}{" neutrinos. Returning 0."} << endl;
111     \textcolor{keywordflow}{return} 0;
112   \}
113 
114   \textcolor{keywordflow}{if}(j == 1)\{ 
115     \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[i-1];
116   \}
117   \textcolor{keywordflow}{else} \{
118     \textcolor{comment}{// Combine Gamma31, Gamma21 and an angle (fGamma[0] = cos(th)) to make Gamma32}
119     \textcolor{keywordtype}{double} arg = \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[1] * ( 4*\hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[2] - \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[1]*(1 - pow(
      \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[0],2)) );
120 
121     \textcolor{keywordflow}{return} \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[2] + \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[1]*pow(\hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[0],2) - \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[0] * sqrt(arg);
122 
123   \}
124 
125 \}
...
Definition at line 160 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
161 \{
162 
163   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} out(3, \hyperlink{classOscProb_1_1PMNS__Deco_a34634741bc68bc1c524cf47f44e7f5b6}{row}(3,0));
164   
165   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<3; i++)\{
166   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<3; j++)\{
167   
168     out[i][j] += A[i][j] * B[i][j];
169 
170   \}\}
171   
172   \textcolor{keywordflow}{return} out;
173 
174 \}
\end{DoxyCode}
...
Definition at line 307 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
\begin{DoxyCode}
308 \{
309   assert(flv>=0 && flv<\hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus});
310   \textcolor{keywordflow}{return} sqrt(norm(\hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}[flv][flv]));
311 \}
\end{DoxyCode}
...
Definition at line 205 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
206 \{
207 
208   \textcolor{comment}{// Set the neutrino path}
209   \hyperlink{classOscProb_1_1PMNS__Base_a986e6ebef09a7e2eb7fee16a4c2c834d}{SetCurPath}(p);
210 
211   \textcolor{comment}{// Solve for eigensystem}
212   \hyperlink{classOscProb_1_1PMNS__Fast_a8a0828401591e88c60e0051fbfe02d5e}{SolveHam}();
213   
214   \textcolor{comment}{// The code below is not pretty or optimised at all. Lots of matrix}
215   \textcolor{comment}{// multiplications are going on which could be otpimised due to }
216   \textcolor{comment}{// symmetry. The index sorting is also terrible. Needs improving.}
217 
218   \textcolor{comment}{// Store rotation matrices}
219   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} U = \hyperlink{classOscProb_1_1PMNS__Base_a093e7bd31d4ef52ed52df414e12c1d17}{fEvec};
220   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} Ut = \hyperlink{classOscProb_1_1PMNS__Deco_aca391ff02be7abc2fd3dba40e9ce2665}{CTransp}(\hyperlink{classOscProb_1_1PMNS__Base_a093e7bd31d4ef52ed52df414e12c1d17}{fEvec});
221 
222   \textcolor{comment}{// Rotate to effective mass basis}
223   \hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho} = \hyperlink{classOscProb_1_1PMNS__Deco_a8d6b547de294c0d52d4208bde44fe171}{Dot}(Ut, \hyperlink{classOscProb_1_1PMNS__Deco_a8d6b547de294c0d52d4208bde44fe171}{Dot}(\hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}, U));
224   
225   \textcolor{comment}{// Compute evolution matrix}
226   \hyperlink{classOscProb_1_1PMNS__Deco_a77b4e0c041b6268910a270be0f5387c9}{matrix} evolve(3, \hyperlink{classOscProb_1_1PMNS__Deco_a34634741bc68bc1c524cf47f44e7f5b6}{row}(3,1));
227   
228   \textcolor{comment}{// Some ugly way of matching gamma and dmsqr indices}
229   \textcolor{keywordtype}{int} maxdm = 0; 
230   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[1] > \hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[maxdm]) maxdm = 1;
231   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[2] > \hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[maxdm]) maxdm = 2;
232 
233   \textcolor{keywordtype}{int} mindm = 0; 
234   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[1] < \hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[mindm]) mindm = 1;
235   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[2] < \hyperlink{classOscProb_1_1PMNS__Base_a406a31c3b5d620e5a0cace5b411f9f70}{fDm}[mindm]) mindm = 2;
236 
237   \textcolor{keywordtype}{int} middm = 0;
238   \textcolor{keywordflow}{if}(middm == maxdm || middm == mindm) middm = 1; 
239   \textcolor{keywordflow}{if}(middm == maxdm || middm == mindm) middm = 2; 
240 
241   \textcolor{keywordtype}{int} maxev = 0; 
242   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[1] > \hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[maxev]) maxev = 1;
243   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[2] > \hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[maxev]) maxev = 2;
244 
245   \textcolor{keywordtype}{int} minev = 0; 
246   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[1] < \hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[minev]) minev = 1;
247   \textcolor{keywordflow}{if}(\hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[2] < \hyperlink{classOscProb_1_1PMNS__Base_a6319c34d7decbb9d7d6da279c06e8c2d}{fEval}[minev]) minev = 2;
248 
249   \textcolor{keywordtype}{int} midev = 0;
250   \textcolor{keywordflow}{if}(midev == maxev || midev == minev) midev = 1; 
251   \textcolor{keywordflow}{if}(midev == maxev || midev == minev) midev = 2; 
252   
253   \textcolor{keywordtype}{int} idx[3];
254   idx[minev] = mindm;
255   idx[midev] = middm;
256   idx[maxev] = maxdm;
257   
258   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<3; j++)\{ 
259   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<j; i++)\{
260     \hyperlink{classOscProb_1_1PMNS__Base_ae86ec4718808ce9d02e5f5b4226714ab}{complex} arg = \hyperlink{classOscProb_1_1PMNS__Base_ae86ec4718808ce9d02e5f5b4226714ab}{complex}(\hyperlink{classOscProb_1_1PMNS__Deco_a73461e806063588a8e3a9d5d0dd201cb}{GetGamma}(max(idx[i],idx[j])+1,min(idx[i],idx[j])+1) * 
...
261     evolve[i][j] = exp(-arg);
262     evolve[j][i] = exp(-conj(arg));
263   \}\}
264   
265   \textcolor{comment}{// Evolve density matrix}
266   \hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho} = \hyperlink{classOscProb_1_1PMNS__Deco_aacc9909556ca22aca30620893e12b0db}{Mult}(\hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}, evolve);
267   
268   \textcolor{comment}{// Rotate back to flavour basis}
269   \hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho} = \hyperlink{classOscProb_1_1PMNS__Deco_a8d6b547de294c0d52d4208bde44fe171}{Dot}(U, \hyperlink{classOscProb_1_1PMNS__Deco_a8d6b547de294c0d52d4208bde44fe171}{Dot}(\hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}, Ut));
270 
271 \}
\end{DoxyCode}
...
Definition at line 284 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
\begin{DoxyCode}
285 \{
286   assert(flv>=0 && flv<\hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus});
287   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<\hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus}; ++i)\{
288   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j=0; j<\hyperlink{classOscProb_1_1PMNS__Base_a24bb74bed63569dfe88b18fa6a08060e}{fNumNus}; ++j)\{
289     \textcolor{keywordflow}{if} (i==flv && i==j) \hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}[i][j] = \hyperlink{classOscProb_1_1PMNS__Base_ab64aab27448a5aca27565c991a9d173e}{one};
290     \textcolor{keywordflow}{else}                \hyperlink{classOscProb_1_1PMNS__Deco_a0488d62b4ef4cf5b43425769f5fcdbdf}{fRho}[i][j] = \hyperlink{classOscProb_1_1PMNS__Base_a5c31ed4593cf95feb36fb80c1850d25e}{zero};
291   \}\}
292 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{Set\+Deco\+Angle(double th)}{SetDecoAngle(double th)}}]{\setlength{\rightskip}{0pt plus 5cm}void P\+M\+N\+S\+\_\+\+Deco\+::\+Set\+Deco\+Angle (
\begin{DoxyParamCaption}
\item[{double}]{th}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\hypertarget{classOscProb_1_1PMNS__Deco_a35e79054682aa88c55f4350c29336014}{}\label{classOscProb_1_1PMNS__Deco_a35e79054682aa88c55f4350c29336014}
...
Definition at line 81 of file P\+M\+N\+S\+\_\+\+Deco.\+cxx.
...
82 \{
83 
84   \hyperlink{classOscProb_1_1PMNS__Deco_ae2f30ac9f8b25344959f1698616d337a}{fGamma}[0] = cos(th);
85   
86 \}
\end{DoxyCode}
