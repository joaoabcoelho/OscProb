  ...
  class PMNS_NSI : public PMNS_Fast {
    public:
      ...
      void SetNSI(double eps_ee, double eps_emu, double eps_etau,
                  ...
                  double delta_emu = 0, double delta_etau = 0,
      ...
      virtual void SetEps_etau(double a,
                               double phi); ///< Set eps_etau parameter
      virtual void SetEps_mutau(double a,
                                double phi); ///< Set eps_mutau parameter
      ...
      virtual void SetFermCoup(double e, double u,
                               double d); ///< Set all fermion couplings
      virtual void SetCoupByIndex(double c,
                                  int    i); ///< Set a given fermion coupling
