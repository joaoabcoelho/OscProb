...
namespace OscProb {
  ...
  class PMNS_LIV : public PMNS_Fast {
    ...
    protected:
      ...
      complexD faT[3][3]
                  [3]; ///< Stores each aT LIV parameter of dimension 3,5,7
      complexD fcT[3][3]
                  [3]; ///< Stores each cT LIV parameter of dimension 4,6,8
    ...
    public:
      ...
      void SetLIV(double aT_ee, double aT_mumu, double aT_tautau, double aT_emu,
                  double aT_etau, double aT_mutau, double cT_ee, double CT_mumu,
                  double CT_tautau, double cT_emu, double cT_etau,
                  double cT_mutau, double delta_aT_emu = 0,
                  double delta_aT_etau = 0, double delta_aT_mutau = 0,
                  double delta_cT_emu = 0, double delta_cT_etau = 0,
